    ...
    if (id) {
        ...
        $("#register").submit(function(event) {
            ...
            $.ajax({
                ...
                data: `status=${"update"}&id=${id}&name=${name}&email=${email}&age=${age}&current_role=${current_role}&recommend_friend=${recommend_friend}&favorite_feature=${favorite_feature}&suggestions=${suggestions}&see_improved=${see_improved}`,
                success: function(result) {
                    
                    alert(result['message']);

                    if(result['message'] == "Update_Successfully") {
